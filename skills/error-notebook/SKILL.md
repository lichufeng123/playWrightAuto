...
## 专题文档同步
- 如果问题属于“AI 自动生成用例流水线”（PRD 转 XMind、测试点提取、生成测试用例、Review、Review 后修订、Excel/CSV/JSON 产物等），解决后还要同步更新 `docx/AI自动生成用例问题记录.md`。
- 专题文档记录要比 `ERROR_LOG.md` 更面向交接：写清用户问题、根因、解决方式、影响文件和后续规则。
- 如果 `docx/AI自动生成用例问题记录.md` 不存在，先创建并按“问题/根因/解决/验证/影响文件”结构维护。
